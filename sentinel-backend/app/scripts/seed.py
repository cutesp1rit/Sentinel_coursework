...
async def seed() -> None:
    ...
    async with AsyncSessionLocal() as db:
        ...
        events = [
            ...
            # ── Rebalance test scenario (days +12, +13, +14) ─────
            ...
            Event(
                user_id=user.id,
                title="Стендап (фикс)",
                description="Ежедневный синк, не переносить",
            ...
            Event(
                ...
                description="Детальное ТЗ для нового модуля уведомлений",
            ...
            Event(
                user_id=user.id,
                title="Ревью кода команды",
                description="Проверить 4 открытых PR до конца дня",
            ...
            Event(
                ...
                description="Баг в авторизации — приоритет P0",
            ...
            Event(
                ...
                description="Покрыть новый сервис ребалансировки тестами",
            ...
            Event(
                user_id=user.id,
                title="Рефакторинг модуля событий",
                description="Выделить бизнес-логику из роутера в сервис",
            ...
            # Day +13: free (one light reminder)
            Event(
                user_id=user.id,
            ...
            # Day +14: one short fixed meeting, rest free
            Event(
                user_id=user.id,
                title="Звонок с ментором (фикс)",
                description="Еженедельный 1:1, нельзя переносить",
