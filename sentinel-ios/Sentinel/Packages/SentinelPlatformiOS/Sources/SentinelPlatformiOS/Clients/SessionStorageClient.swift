...
public struct SessionStorageClient: Sendable {
    public var clear: @Sendable () throws -> Void
    public var load: @Sendable () async throws -> AuthenticatedSession?
    public var save: @Sendable (_ session: AuthenticatedSession) async throws -> Void

    public init(
        clear: @escaping @Sendable () throws -> Void,
        load: @escaping @Sendable () async throws -> AuthenticatedSession?,
        save: @escaping @Sendable (_ session: AuthenticatedSession) async throws -> Void
    ) {
        self.clear = clear
        self.load = load
        self.save = save
...
extension SessionStorageClient: DependencyKey {
    public static let liveValue = SessionStorageClient(
        clear: {
