...
public struct APIClient: Sendable {
    public var send: @Sendable (APIRequest) async throws -> Data

    public init(send: @escaping @Sendable (APIRequest) async throws -> Data) {
        self.send = send
    }
}
...
extension APIClient: DependencyKey {
    public static let liveValue = APIClient(send: liveAPISend)
}
