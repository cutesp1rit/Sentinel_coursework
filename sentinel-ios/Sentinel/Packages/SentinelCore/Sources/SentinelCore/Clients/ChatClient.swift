...
public struct ChatClient: Sendable {
    public var applyActions: @Sendable (_ chatID: UUID, _ messageID: UUID, _ acceptedIndices: [Int], _ bearerToken: String) async throws -> ChatMessage
    public var createChat: @Sendable (_ title: String, _ bearerToken: String) async throws -> Chat
    public var deleteChat: @Sendable (_ chatID: UUID, _ bearerToken: String) async throws -> Void
    public var listChats: @Sendable (_ bearerToken: String) async throws -> [Chat]
    public var listMessages: @Sendable (_ chatID: UUID, _ before: UUID?, _ limit: Int, _ bearerToken: String) async throws -> ([ChatMessage], Bool)
    public var sendMessage: @Sendable (_ chatID: UUID, _ role: String, _ contentText: String?, _ images: [ChatImageAttachment], _ bearerToken: String) async throws -> ChatMessage
    public var uploadImage: @Sendable (_ chatID: UUID, _ filename: String, _ mimeType: String, _ data: Data, _ bearerToken: String) async throws -> ChatImageAttachment

    public init(
        applyActions: @escaping @Sendable (_ chatID: UUID, _ messageID: UUID, _ acceptedIndices: [Int], _ bearerToken: String) async throws -> ChatMessage,
        createChat: @escaping @Sendable (_ title: String, _ bearerToken: String) async throws -> Chat,
        deleteChat: @escaping @Sendable (_ chatID: UUID, _ bearerToken: String) async throws -> Void,
        listChats: @escaping @Sendable (_ bearerToken: String) async throws -> [Chat],
        listMessages: @escaping @Sendable (_ chatID: UUID, _ before: UUID?, _ limit: Int, _ bearerToken: String) async throws -> ([ChatMessage], Bool),
        sendMessage: @escaping @Sendable (_ chatID: UUID, _ role: String, _ contentText: String?, _ images: [ChatImageAttachment], _ bearerToken: String) async throws -> ChatMessage,
        uploadImage: @escaping @Sendable (_ chatID: UUID, _ filename: String, _ mimeType: String, _ data: Data, _ bearerToken: String) async throws -> ChatImageAttachment
    ) {
